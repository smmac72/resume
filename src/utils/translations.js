...
const translations = {
  en: {
    ...
    auth_required: 'Authentication required. Use login [user] [pass]',
    ...
    logins_txt: 'zeromac:naughtshad@87.251.78.2\nzeromac:allsspent@87.251.78.3\nzeromac:whereourdesire@87.251.78.4',
    servers_conf: 'Available servers on network:\n87.251.78.2 — Work Server\n87.251.78.3 — Pet Projects\n87.251.78.4 — Personal Server',
    ...
    readme_chernograd: 'a small piece of our kgb—simulator indie game. led the development team there — guys even found an investor there\nyet, didn\'t work out for me. happens. I hold these memories dearly.',
    ...
    readme_personal: 'hiya! my name\'s oleg, I am a full—time game designer (mobile f2p and mmorpg), even more than a full—time student. game design stuff is on the other servers, here\'s more about me. I am a:\n– programming guy at my core\n– cameraman and video editor since middle school\n– home trained half—professional cook with a decade of learning and experimenting\n– true shakespearean (new) english enjoyer — you did get the mcbeth reference from the server passwords, right? or you can accept it as a metal gear solid 2: sons of liberty reference\n– long airsoft enjoyer with my masada acr and lots of custom gear. alas, I gave my hobby away to grow as a professional\n\nactually, I am pretty cool! if you are not hiring, we can at least share the best sandwich in saint—p!',
    readme_birthday: 'once I forgot about my friend\'s birthday. I was so ashamed, that I created a working app to track everyone\'s birthdays — with groups, registered and unregistered users\nworked wonders, probably will do a bit more with this thing — TODO add wishlists, team discussions for buying presents.',
    readme_anticheat: 'just a small experimental thought — people use only one keyboard/mouse set to play, using something virtual equals to programming inputs = mostly cheating. did a bit of tinkering with WinAPI to filter out the virtual devices (70% of the cheats use this), worked out pretty well.\nseriosly, I don\'t know what to do with this. is it something groundbreaking? am I missing something?',
...
Available commands:
  ...
  ru: {
    ...
    auth_required: 'Требуется аутентификация. Используйте login [user] [pass]',
    ...
    logins_txt: 'zeromac:naughtshad@87.251.78.2\nzeromac:allsspent@87.251.78.3\nzeromac:whereourdesire@87.251.78.4',
    servers_conf: 'Доступные серверы в сети:\n87.251.78.2 — Рабочий сервер\n87.251.78.3 — Персональные проекты\n87.251.78.4 — Личный сервер',
    ...
    readme_chernograd: 'небольшая часть нашей инди—игры симулятора кгб. вел ue5 разработку там, но в последние месяцы больше архитектурно\nкак—то не вышло у меня делать инди, ребята после меня получили инвестиции даже. держу воспоминание об этом в душе, но сам больше не полезу в такое',
    ...
    readme_birthday: 'однажды я забыл о дне рождения своего товарища. мне было настолько стыдно, что я сделал телеграм—бота для отслеживания дней рождения — с группами, регистрацией, учетом незарегистрированных\nчудесный проект, надо заняться им дальше — TODO сделать вишлисты, сбор людей в группы для покупки товаров. ну и поднять бота @BirthdayAlertsBot.',
    readme_anticheat: 'небольшая экспериментная мысль — люди обычно используют один набор из мышки/клавиатуры, а весь программный инпут = в основном читы. немного покопался в WinAPI, сделал фильтр на виртуальный инпут (70% читов), сработало хорошо.\nна самом деле, не знаю что с этим делать. это что—то прорывное? или я где—то что—то упустил?',
